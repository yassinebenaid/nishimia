...
A fully functional interpreter for a custom language called `nishimia`, weird name I know, however its real, it does interpret the language below with support for :
